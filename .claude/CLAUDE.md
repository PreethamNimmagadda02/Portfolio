...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-19 (commit e9ba8f0). Confidence: 100%.
...
- `src/components/Experience.tsx` — 9 commits/90d (98.5th %ile)
- `src/components/Hero.tsx` — 10 commits/90d (97.0th %ile)
- `src/components/ParticleField.tsx` — 4 commits/90d (95.5th %ile)
- `src/components/Projects.tsx` — 9 commits/90d (94.0th %ile)

### Code health
Three co-equal signals: defect risk 7.03/10 avg, hotspot health 5.11/10 (stable), worst `src/components/Navbar.tsx` at 3.28/10 · maintainability 9.29/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
