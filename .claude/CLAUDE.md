...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-18 (commit 2d57026). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 6.79/10 avg, hotspot health 5.02/10 (stable), worst `src/components/Experience.tsx` at 4.25/10 · maintainability 9.29/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `src/components/Experience.tsx` — change entropy — impact −1.5
- `src/components/Projects.tsx` — change entropy — impact −1.4
