...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-21 (commit 9beb45e). Confidence: 100%.
...
### Architecture
repo is a high-performance frontend component library that consumes raw UI state and motion parameters to render interactive, physics-based web interfaces via a React-driven animation pipeline. It transforms declarative motion configurations into optimized DOM transitions, producing a responsive, accessible user experience integrated with real-time performance monitoring.

### Hotspots (high churn — check `get_risk` before editing)
- `src/app/globals.css` — 9 commits/90d (100.0th %ile)
- `.repowise/.update.log` — 9 commits/90d (98.6th %ile)
- `.repowise/knowledge-graph.json` — 9 commits/90d (97.1th %ile)
