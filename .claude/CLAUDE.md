...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-21 (commit 03b4563). Confidence: 100%.
...
### Architecture
repo is a high-performance UI animation and interaction framework that consumes raw React component definitions and motion configuration objects, processes them through a viewport-aware state engine, and outputs fluid, accessible, and performant DOM transitions.

### Hotspots (high churn — check `get_risk` before editing)
- `.repowise/.update.log` — 11 commits/90d (100.0th %ile)
- `.repowise/knowledge-graph.json` — 11 commits/90d (98.6th %ile)
